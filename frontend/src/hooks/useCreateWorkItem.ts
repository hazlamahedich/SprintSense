...
interface UseCreateWorkItemReturn {
  createWorkItem: (teamId: string, data: CreateWorkItemRequest) => Promise<WorkItem>;
...
const parseErrorMessage = (error: any): string => {
  ...
  // Fallback
  return error?.message || 'An unexpected error occurred while creating the work item';
};
