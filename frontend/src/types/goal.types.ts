...
export const EXAMPLE_GOALS: Omit<ProjectGoalCreateRequest, 'team_id'>[] = [
  {
    description:
      'Improve user engagement by 25% through better navigation and search functionality',
    priority_weight: 8,
    success_metrics:
      'Monthly active users increase by 25%, session duration increases by 15%',
  },
  {
    description:
      'Reduce customer support tickets by implementing comprehensive self-service features',
    priority_weight: 7,
    success_metrics: 'Support ticket volume decreases by 30% within 3 months',
  },
  {
    description:
      'Enhance system performance and reliability to improve user experience',
    priority_weight: 9,
    success_metrics:
      'Page load times under 2 seconds, 99.9% uptime, user satisfaction score >4.5',
  },
  {
    description:
      'Increase product adoption among new users with improved onboarding',
    priority_weight: 6,
    success_metrics:
      'Onboarding completion rate >80%, first-week retention >60%',
  },
]
