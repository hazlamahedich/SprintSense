...
## Acceptance Criteria
1. A new database migration is created for the `work_items` and `story_points` tables/fields.
...
- Foreign key relationships: Team (1:Many), User as author (1:Many), User as assignee (1:Many), Sprint (1:Many)
