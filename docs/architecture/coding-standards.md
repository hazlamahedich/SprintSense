...
This document outlines the coding standards for the SprintSense project.

## General Principles

- **Clarity and Readability:** Code should be easy to read and understand.
- **Consistency:** Code should be consistent with the existing codebase.
...
- **Language:** TypeScript
- **Framework:** React
- **Styling:** Material-UI (MUI) with `@mui/system`
- **State Management:** Zustand
- **Linting:** ESLint with the recommended TypeScript and React plugins.
- **Formatting:** Prettier
...
- **Format:** Conventional Commits format is preferred.
